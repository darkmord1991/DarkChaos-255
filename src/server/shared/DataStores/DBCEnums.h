...
enum SpawnMask
{
    ...
    SPAWNMASK_DUNGEON_MYTHIC      = (1 << DUNGEON_DIFFICULTY_MYTHIC),
    SPAWNMASK_DUNGEON_MYTHIC_PLUS = (1 << DUNGEON_DIFFICULTY_MYTHIC_PLUS),
    SPAWNMASK_DUNGEON_ALL         = (SPAWNMASK_DUNGEON_NORMAL | SPAWNMASK_DUNGEON_HEROIC |
                                     SPAWNMASK_DUNGEON_MYTHIC | SPAWNMASK_DUNGEON_MYTHIC_PLUS),
    ...
    SPAWNMASK_RAID_10MAN_MYTHIC   = (1 << RAID_DIFFICULTY_10MAN_MYTHIC),
    SPAWNMASK_RAID_25MAN_MYTHIC   = (1 << RAID_DIFFICULTY_25MAN_MYTHIC),
    SPAWNMASK_RAID_HEROIC_ALL     = (SPAWNMASK_RAID_10MAN_HEROIC | SPAWNMASK_RAID_25MAN_HEROIC),
    SPAWNMASK_RAID_MYTHIC_ALL     = (SPAWNMASK_RAID_10MAN_MYTHIC | SPAWNMASK_RAID_25MAN_MYTHIC),

    SPAWNMASK_RAID_ALL            = (SPAWNMASK_RAID_NORMAL_ALL | SPAWNMASK_RAID_HEROIC_ALL |
                                     SPAWNMASK_RAID_MYTHIC_ALL),
};
