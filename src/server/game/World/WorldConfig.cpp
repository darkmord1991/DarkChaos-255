...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<float>(RATE_HEALTH_REST_AREA, "Rate.Health.RestArea", 3.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
    ...
    SetConfigValue<float>(RATE_POWER_MANA_REST_AREA, "Rate.Mana.RestArea", 3.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value > 0.0f; }, "> 0");
