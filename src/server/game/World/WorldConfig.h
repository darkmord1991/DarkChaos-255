...
enum ServerConfigs
{
    ...
    CONFIG_NUMTHREADS,
    CONFIG_MAP_PARTITIONS_ENABLED,
    CONFIG_MAP_PARTITIONS_BORDER_OVERLAP,
    CONFIG_MAP_PARTITIONS_DEFAULT_COUNT,
    CONFIG_MAP_PARTITIONS_MAPS,
    CONFIG_MAP_PARTITIONS_STORE_ONLY,
    CONFIG_MAP_PARTITIONS_USE_PARALLEL_UPDATES,
    CONFIG_MAP_PARTITIONS_EXCLUDE_ZONES,
    CONFIG_MAP_PARTITIONS_TILE_BASED_ENABLED,
    CONFIG_MAP_PARTITIONS_TILE_BASED_TILES_PER_PARTITION,
    CONFIG_MAP_PARTITIONS_TILE_BASED_MIN_PARTITIONS,
    CONFIG_MAP_PARTITIONS_TILE_BASED_MAX_PARTITIONS,
    CONFIG_MAP_PARTITIONS_TILE_BASED_TILES_PER_PARTITION_OVERRIDES,
    CONFIG_MAP_PARTITIONS_TILE_BASED_PARTITION_OVERRIDES,
    CONFIG_MAP_PARTITIONS_LAYERS_ENABLED,
    CONFIG_MAP_PARTITIONS_LAYER_CAPACITY,
    CONFIG_MAP_PARTITIONS_LAYER_MAX,
    CONFIG_MAP_PARTITIONS_NPC_LAYERS,
    CONFIG_MAP_PARTITIONS_GO_LAYERS,
    CONFIG_MAP_PARTITIONS_SKIP_CLONES_NO_PLAYERS,
    CONFIG_MAP_PARTITIONS_LAYER_CLONE_METRICS,
    CONFIG_MAP_PARTITIONS_LAYER_LAZY_CLONE_LOADING,
    CONFIG_MAP_PARTITIONS_LAYER_CAPACITY_OVERRIDES,
    CONFIG_MAP_PARTITIONS_LAYER_HYSTERESIS_CREATION_MS,
    CONFIG_MAP_PARTITIONS_LAYER_HYSTERESIS_DESTRUCTION_MS,
    CONFIG_MAP_PARTITIONS_LAYER_SOFT_TRANSFERS,
    CONFIG_MAP_PARTITIONS_LAYER_SOFT_TRANSFER_TIMEOUT_MS,
    CONFIG_MAP_PARTITIONS_LAYER_REBALANCING_ENABLED,
    CONFIG_MAP_PARTITIONS_LAYER_REBALANCING_INTERVAL_MS,
    CONFIG_MAP_PARTITIONS_LAYER_REBALANCING_MIN_PLAYERS,
    CONFIG_MAP_PARTITIONS_LAYER_REBALANCING_IMBALANCE_THRESHOLD,
    CONFIG_MAP_PARTITIONS_LAYER_REBALANCING_MIGRATION_BATCH,
    CONFIG_MAP_PARTITIONS_DENSITY_SPLIT_THRESHOLD,
    CONFIG_MAP_PARTITIONS_DENSITY_MERGE_THRESHOLD,
