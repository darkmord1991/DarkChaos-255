...
void Player::GiveXP(uint32 xp, Unit* victim, float group_rate, bool isLFGReward)
{
    ...
    // Downgraded to DEBUG to avoid flooding normal server logs; raise to INFO when actively debugging.
    LOG_DEBUG("scripts", "InstrumentXP: Player::GiveXP -> player {} receiving {} XP (victimGUID={} entry={}) hasAura800001={} pos=({:.1f},{:.1f},{:.1f}) map={}",
