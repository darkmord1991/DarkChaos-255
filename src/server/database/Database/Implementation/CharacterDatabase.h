...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_CHARACTER_SOCIAL_FLAGS_BY_FRIEND,
    ...
    CHAR_SEL_PARTITION_OWNERSHIP,
    CHAR_REP_PARTITION_OWNERSHIP,
    CHAR_DEL_PARTITION_OWNERSHIP_OTHER_MAPS,

    // Map Partitioning Layer Assignment
    CHAR_SEL_DC_LAYER_ASSIGNMENT,
    CHAR_REP_DC_LAYER_ASSIGNMENT,
