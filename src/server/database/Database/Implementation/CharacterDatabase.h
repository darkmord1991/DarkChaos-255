...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    // Hinterland Battleground (HLBG) prepared statements
    CHAR_INS_HLBG_BATTLE_START,
    CHAR_UPD_HLBG_BATTLE_END,
    CHAR_UPD_HLBG_BATTLE_PLAYERS,
    CHAR_INS_HLBG_PLAYER_ENTER,
    CHAR_UPD_HLBG_PLAYER_KILLS,
    CHAR_UPD_HLBG_PLAYER_DEATHS,
    CHAR_UPD_HLBG_STATISTICS_KILLS,
    CHAR_UPD_HLBG_PLAYER_RESOURCES,
    CHAR_UPD_HLBG_ALLIANCE_WINS,
    CHAR_UPD_HLBG_HORDE_WINS,
    CHAR_SEL_HLBG_PARTICIPANT_COUNT,
    CHAR_UPD_HLBG_TOTAL_PARTICIPANTS,
    ...
    CHAR_DEL_MPLUS_KEYSTONE,
    CHAR_INS_MPLUS_RUN_HISTORY,
    CHAR_SEL_MPLUS_BEST_TIME,
    CHAR_INS_MPLUS_SCORE,
    CHAR_INS_MPLUS_WEEKLY_VAULT,
    CHAR_INS_MPLUS_TOKEN_LOG,
    CHAR_INS_GROUP_FINDER_LISTING,
    CHAR_SEL_MPLUS_VAULT_REWARDS,

    // DarkChaos Hotspots (per-realm runtime state; see DC/Hotspot/)
    CHAR_SEL_DC_HOTSPOTS_ACTIVE,
    CHAR_REP_DC_HOTSPOT_ACTIVE,
    CHAR_DEL_DC_HOTSPOT_ACTIVE,
    CHAR_SEL_DC_HOTSPOT_SPAWN_POINTS,
    CHAR_INS_DC_HOTSPOT_SPAWN_POINT,
