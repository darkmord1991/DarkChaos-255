...
namespace ShadowfangKeepCata::BaronSilverlaine
{
enum Texts
{
    SAY_AGGRO = 0,
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            switch (eventId)
            {
                ...
                case EVENT_SUMMON_WORGEN_SPIRIT:
                {
                    ...
                    me->CastCustomSpell(SPELL_SUMMON_WORGEN_SPIRIT, SPELLVALUE_BASE_POINT0, bp0, me, true);
                    break;
                }
                default:
                    break;
...
{
    PrepareSpellScript(spell_sfk_summon_worgen_spirit);
    ...
    {
        OnEffectHitTarget += SpellEffectFn(spell_sfk_summon_worgen_spirit::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
}
...
void AddSC_boss_baron_silverlaine()
{
    ...
    using namespace ShadowfangKeepCata::BaronSilverlaine;
    RegisterShadowfangKeepCataCreatureAI(boss_baron_silverlaine);
    RegisterShadowfangKeepCataCreatureAI(npc_sfk_worgen_spirit);
