...
void HotspotMgr::LoadConfig()
{
    ...
    sHotspotsConfig.radius = sConfigMgr->GetOption<float>("Hotspots.Radius", 300.0f);
    ...
    sHotspotsConfig.announceRadius = sConfigMgr->GetOption<float>("Hotspots.AnnounceRadius", 1000.0f);
