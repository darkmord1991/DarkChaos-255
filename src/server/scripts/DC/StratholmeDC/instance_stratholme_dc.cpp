...
// ---------------------------------------------------------------------------------
// DARKCHAOS CLONE -- map 821. Generated from instance_stratholme.cpp, then renamed.
//
...
class instance_stratholme_dc : public InstanceMapScript
{
public:
    instance_stratholme_dc() : InstanceMapScript("instance_stratholme_dc", MAP_STRATHOLME_DC) { }

    struct instance_stratholme_dc_InstanceMapScript : public InstanceScript
    {
        instance_stratholme_dc_InstanceMapScript(Map* map) : InstanceScript(map)
        {
    ...
    {
        return new instance_stratholme_dc_InstanceMapScript(map);
    }
};

void AddSC_instance_stratholme_dc()
{
    new instance_stratholme_dc();
}
