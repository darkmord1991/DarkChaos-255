...
enum Spells
{
    ...
    // Teleport spells -- see NOTE below: casts replaced by NearTeleportTo
...
// spell_target_position 28025 -- Gothik to the spectral (dead) side
constexpr float GOTHIK_DEAD_X = 2692.65f, GOTHIK_DEAD_Y = -3321.06f, GOTHIK_DEAD_Z = 267.684f, GOTHIK_DEAD_O = 4.70454f;
// spell_target_position 28026 -- Gothik to the living side
constexpr float GOTHIK_LIVE_X = 2705.95f, GOTHIK_LIVE_Y = -3412.45f, GOTHIK_LIVE_Z = 267.688f, GOTHIK_LIVE_O = 2.19126f;
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_TELEPORT:
                    ...
                    if (IN_LIVE_SIDE(me))
                    {
                        me->NearTeleportTo(GOTHIK_DEAD_X, GOTHIK_DEAD_Y, GOTHIK_DEAD_Z, GOTHIK_DEAD_O, true);
                    }
                    else
                    {
                        me->NearTeleportTo(GOTHIK_LIVE_X, GOTHIK_LIVE_Y, GOTHIK_LIVE_Z, GOTHIK_LIVE_O, true);
                    }
                    {
