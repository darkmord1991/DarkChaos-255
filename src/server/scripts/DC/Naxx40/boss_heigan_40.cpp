...
enum Spells
{
    ...
    SPELL_TELEPORT_SELF             = 30211,  // see NOTE below: cast replaced by NearTeleportTo
...
// spell_target_position 30211 -- Heigan down to the dance platform
constexpr float HEIGAN_PLATFORM_X = 2793.86f, HEIGAN_PLATFORM_Y = -3707.38f, HEIGAN_PLATFORM_Z = 276.64f, HEIGAN_PLATFORM_O = 2.32f;
    ...
    struct boss_heigan_40AI : public BossAI
    {
        ...
        void StartFightPhase(uint8 phase)
        {
            ...
            else // if (phase == PHASE_FAST_DANCE)
            {
                ...
                me->NearTeleportTo(HEIGAN_PLATFORM_X, HEIGAN_PLATFORM_Y, HEIGAN_PLATFORM_Z, HEIGAN_PLATFORM_O, true);
