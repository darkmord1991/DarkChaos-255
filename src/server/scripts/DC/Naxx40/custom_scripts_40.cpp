...
public:
    ...
    bool OnTrigger(Player* player, AreaTrigger const* areaTrigger) override
    {
        ...
        {
            // Naxx 10 and 25 entrances -- DC: stays map 533 (stock WotLK Naxxramas).
            // The 40-man lives on map 2921 and is entered via the EPL teleporter GO 361001.
            case 5191:
...
public:
    ...
    void OnPlayerEnterAll(Map* map, Player* player) override
    {
        ...
        // Check if mapId equals to Naxxramas (DC: map 2921)
        if (map->GetId() != NaxxramasMapId)
            return;
