...
class instance_naxxramas_40 : public InstanceScript
{
public:
    instance_naxxramas_40(Map* map) : InstanceScript(map)
    {
...
class at_naxxramas_hub_portal_40 : public AreaTriggerScript
{
public:
    at_naxxramas_hub_portal_40() : AreaTriggerScript("at_naxxramas_hub_portal_40") { }
...
{
    RegisterInstanceScript(instance_naxxramas_40, NaxxramasMapId);
    ...
    new at_naxxramas_hub_portal_40();
}
