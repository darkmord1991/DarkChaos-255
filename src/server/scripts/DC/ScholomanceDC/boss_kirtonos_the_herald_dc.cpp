...
// ---------------------------------------------------------------------------------
// DARKCHAOS CLONE -- map 822. Generated from boss_kirtonos_the_herald.cpp, then renamed.
//
...
class boss_kirtonos_the_herald_dc : public CreatureScript
{
public:
    boss_kirtonos_the_herald_dc() : CreatureScript("boss_kirtonos_the_herald_dc") { }

    struct boss_kirtonos_the_herald_dcAI : public ScriptedAI
    {
        boss_kirtonos_the_herald_dcAI(Creature* creature) : ScriptedAI(creature)
        {
    ...
    {
        return GetScholomanceDCAI<boss_kirtonos_the_herald_dcAI>(creature);
    }
};

void AddSC_boss_kirtonos_the_herald_dc()
{
    new boss_kirtonos_the_herald_dc();
}
