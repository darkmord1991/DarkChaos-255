...
// The script registration functions are defined with C linkage (extern "C")
// in their source files, so declare them with extern "C" here to ensure the
// linker sees matching unmangled symbols.
extern "C" {
