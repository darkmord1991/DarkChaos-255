...
// #include "ItemUpgradeCommunication.h" // Removed - header file not found
#include <sstream>
#include <iomanip>
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        // ItemUpgradeCommunicationHandler::OpenUpgradeInterface(player); // Removed - handler not available
