...
**ISSUE:** Lines 130-169 have TODO comments for teleportation
...
case GOSSIP_ACTION_MYTHIC:
{
    ...
    // TODO: Implement teleport to dungeon entrance  <-- MISSING!
...
{
    // Determine which affixes are active this week
...
```cpp
std::vector<AffixType> MythicPlusRunManager::GetWeeklyAffixes(uint32 seasonId) const
{
    uint32 weekNum = (GetWeekStartTimestamp() / (7 * DAY)) % 52;
