...
- Only **featured dungeons** allowed per season
- Season 1: 10 WotLK dungeons
...
✅ `dc_mplus_featured_dungeons` - 10 dungeons for Season 1
...
-- Check featured dungeons (should be 10)
SELECT COUNT(*) FROM dc_mplus_featured_dungeons WHERE season_id = 1;
...
**Fix Option 1**: Add to featured list
```sql
...
**Medium Priority**:
4. Add seasonal validation (check `dc_mplus_featured_dungeons`)
