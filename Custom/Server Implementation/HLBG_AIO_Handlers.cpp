...
private:
    ...
    static void HandleRequestStatus(Player* player, Aio* /*aio*/, AioPacket packet)
    {
        ...
        uint32 allianceResources = GetCurrentAllianceResources(); // Implement this
        uint32 hordeResources = GetCurrentHordeResources();       // Implement this
        uint32 currentAffix = GetCurrentAffix();                  // Implement this
        uint32 timeRemaining = GetBattleTimeRemaining();          // Implement this
