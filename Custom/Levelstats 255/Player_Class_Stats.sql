...
-- Exportiere Daten aus Tabelle acore_world.player_class_stats: 746 rows
DELETE FROM `player_class_stats`;
/*!40000 ALTER TABLE `player_class_stats` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `player_class_stats` ENABLE KEYS */;
