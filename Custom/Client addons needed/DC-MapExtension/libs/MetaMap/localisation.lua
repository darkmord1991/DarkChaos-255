...
--missing
METAMAP_BATTLEGROUNDS = "BattleGrounds";
METAMAP_INSTANCES = "Instances";
METAMAP_INSTANCE = "Instance";
METAMAP_INSTANCE_1 = "|cff00ff00Instance";
METAMAP_SEVEDINSTANCES = "Saved Instances";
METAMAP_FURINF = "|cffffffffFurther information may be added at a later date...|r";
METAMAP_CURZONE = "CurrentZone: |cff00ff00";
METAMAP_MYLOCATION = "My location: ";
METAMAP_NO_SAVED_INSTANCES = "|cffffffffNo saved instances";
METAMAP_MAP_ICON_ON = "|cff00ff00On|r   Map Icon"
METAMAP_MAP_ICON_OFF = "|cffff0000Off|r   Map Icon"
METAMAP_FIND_HERBS = "Find Herbs"
METAMAP_FIND_MINERALS = "Find Minerals"
