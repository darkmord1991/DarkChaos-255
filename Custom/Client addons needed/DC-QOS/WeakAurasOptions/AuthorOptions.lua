  ...
  select = function(options, args, data, order, prefix, i)
    ...
    for j, value in ipairs(values) do
      ...
      args[prefix .. "valdelete" .. j] = {
        ...
        image = OptionsPrivate.GetTexture("delete"),
        imageWidth = 24,
        imageHeight = 24,
...
function addAuthorModeOption(options, args, data, order, prefix, i)
  ...
  args[prefix .. "collapse"] = {
    ...
    image = collapsed and OptionsPrivate.GetTexture("expand") or
      OptionsPrivate.GetTexture("collapse"),
    imageWidth = 18,
    imageHeight = 18,
  ...
  args[prefix .. "upAndIn"] = {
    ...
    image = OptionsPrivate.GetTexture("upright"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
  args[prefix .. "downAndIn"] = {
    ...
    image = OptionsPrivate.GetTexture("downright"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
  ...
  args[prefix .. "upAndOut"] = {
    ...
    image = OptionsPrivate.GetTexture("upleft"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
  args[prefix .. "downAndOut"] = {
    ...
    image = OptionsPrivate.GetTexture("downleft"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
  ...
  args[prefix .. "up"] = {
    ...
    disabled = upDisable,
    func = upFunc,
    image = OptionsPrivate.GetTexture("moveup"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
  ...
  args[prefix .. "down"] = {
    ...
    func = downFunc,
    image = OptionsPrivate.GetTexture("movedown"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
  ...
  args[prefix .. "duplicate"] = {
    ...
    image = OptionsPrivate.GetTexture("duplicate"),
    imageWidth = 24,
    imageHeight = 24,
    control = "WeakAurasIcon"
  }
    ...
    if not collapsed then
      ...
      if option.groupType == "array" then
        ...
        args[prefix .. "resetEntry"] = {
          ...
          width = 0.15,
          image = OptionsPrivate.GetTexture("reset"),
          imageWidth = 18,
          imageHeight = 18,
          control = "WeakAurasIcon"
        }
        if option.limitType ~= "fixed" then
          args[prefix .. "createEntry"] = {
            ...
            width = 0.15,
            image = OptionsPrivate.GetTexture("add"),
            imageWidth = 18,
            imageHeight = 18,
            control = "WeakAurasIcon"
          }
