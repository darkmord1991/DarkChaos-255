...
-- Embedded addon paths (DC-QOS)
WeakAuras.AddonPath = "Interface\\AddOns\\DC-QOS\\WeakAuras"
WeakAuras.MediaPath = WeakAuras.AddonPath .. "\\Media"
WeakAuras.TexturePath = WeakAuras.MediaPath .. "\\Textures"
WeakAuras.IconPath = WeakAuras.TexturePath .. "\\icon"

-- When embedded in DC-QOS, use hardcoded version since metadata lookup will fail
local versionStringFromToc = GetAddOnMetadata("WeakAuras", "Version") or GetAddOnMetadata("DC-QOS", "Version") or "4.0.0"
local versionString = "4.0.0"
local buildTime = "20201210233053"

WeakAuras.versionString = versionStringFromToc ~= nil and versionStringFromToc or versionString
