...
function AzerothAdminCommands.ApplyDarkModePreset()
  if UnitAffectingCombat and UnitAffectingCombat("player") then
    print("AzerothAdmin: leave combat before applying the dark preset.")
    return false
  end

  local style = AzerothAdmin.db.profile.style
  style.color.buffer = {}
  style.color.backgrounds = {
    r = 0,
    g = 0,
    b = 0
  }
  ...
  style.transparency.backgrounds = 1.0
  style.transparency.frames = 0.92
  style.transparency.buttons = 1.0

  if ma_checktransparencybutton and ma_checktransparencybutton.SetChecked then
