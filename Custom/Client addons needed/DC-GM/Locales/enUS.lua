...
--[[NPC Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_WayStart"]                   = "Create a NEW waypoint path for the selected creature and place WP #1 at your current position.\n\nIf the creature already has a path, use 'Add WP' instead.",
    ["tt_WayEndAdd"]                  = "Add a waypoint at your current position to the END of the path.\n\nUse this to place more waypoints after the first one: move to the next point, then click 'Add WP' again.",
    ["tt_WayShow1"]                   = "Show waypoint markers for the selected creature (numbers).\n\nTo Insert/Delete/Move: target a waypoint marker first, then click the action.",
    ["tt_WayShow0"]                   = "Hide waypoint markers for the selected creature.",
    ["tt_WayMAdd"]                    = "Insert a new waypoint AFTER the selected waypoint marker (at your current position).\n\nRequires: target a waypoint marker (use 'Show').",
    ["tt_WayModifyDel"]               = "Delete the selected waypoint marker from the path.\n\nRequires: target a waypoint marker (use 'Show').",
    ["tt_WayMove"]                    = "Move the selected waypoint marker to your current position.\n\nRequires: target a waypoint marker (use 'Show').",
    ["tt_NPCAdd_WayShowOn"]           = "shows waypoints for the selected creature",
    ["tt_WayWipe"]                    = "Remove ALL waypoints for the selected creature (delete from DB and detach the path).",
    ["tt_WayRun"]                     = "Start the selected creature walking its waypoint path.\n\nRequires: the creature has a path (use 'Start' or 'Add WP' + DB path).\nTip: if it was frozen (stay), this switches it back to waypoint movement.",
    ["tt_WayMDel"]                    = "Delete the selected waypoint marker from the path.\n\nRequires: target a waypoint marker (use 'Show').",
