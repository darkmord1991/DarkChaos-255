...
--[[NPC Tab]]
  ...
  --[[Tooltips]]
    ...
    ["tt_WayStart"]                   = "Start waypoint movement for the selected creature.",
    ["tt_WayMove"]                    = "Move the selected waypoint to your current position.",
    ["tt_WayWipe"]                    = "Delete all waypoints for the selected creature.",
