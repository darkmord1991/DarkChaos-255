-- HLBG_Timer.lua - Timer compatibility for WoW 3.3.5a

-- Record that this file was loaded
if _G.HLBG_RecordFileLoad then
    _G.HLBG_RecordFileLoad("HLBG_Timer.lua")
end
...
if DEFAULT_CHAT_FRAME and _G.HLBG_Debug then
    DEFAULT_CHAT_FRAME:AddMessage("|cFF00EEFFTimer:|r C_Timer compatibility loaded")
end