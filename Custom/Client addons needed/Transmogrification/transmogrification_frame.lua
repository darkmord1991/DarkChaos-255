	...
	rotationArea:SetScript("OnMouseDown", function(frame, button)
		if button == "LeftButton" then
			...
			if not _G["TransmogMouseCapture"] then
				...
				captureFrame:SetPoint("TOPLEFT", UIParent, "TOPLEFT")
				captureFrame:SetPoint("BOTTOMRIGHT", UIParent, "BOTTOMRIGHT")
...
local function InitTabSlots()
	...
	for i = 1, 6, 1 do
		...
		rightTopTexture:ClearAllPoints()
		rightTopTexture:SetPoint("TOPLEFT", rightTopItemFrame, "TOPLEFT")
		rightTopTexture:SetPoint("BOTTOMRIGHT", rightTopItemFrame, "BOTTOMRIGHT")
		...
		rightBottomTexture:ClearAllPoints()
		rightBottomTexture:SetPoint("TOPLEFT", rightBottomItemFrame, "TOPLEFT")
		rightBottomTexture:SetPoint("BOTTOMRIGHT", rightBottomItemFrame, "BOTTOMRIGHT")
		...
		leftTopTexture:ClearAllPoints()
		leftTopTexture:SetPoint("TOPLEFT", leftTopItemFrame, "TOPLEFT")
		leftTopTexture:SetPoint("BOTTOMRIGHT", leftTopItemFrame, "BOTTOMRIGHT")
		...
		leftBottomTexture:ClearAllPoints()
		leftBottomTexture:SetPoint("TOPLEFT", leftBottomItemFrame, "TOPLEFT")
		leftBottomTexture:SetPoint("BOTTOMRIGHT", leftBottomItemFrame, "BOTTOMRIGHT")
...
function OnTransmogrificationFrameLoad(self)
	...
	innerCharacterTransmogTab:ClearAllPoints()
	innerCharacterTransmogTab:SetPoint("TOPLEFT", characterTransmogTab, "TOPLEFT")
	innerCharacterTransmogTab:SetPoint("BOTTOMRIGHT", characterTransmogTab, "BOTTOMRIGHT")
