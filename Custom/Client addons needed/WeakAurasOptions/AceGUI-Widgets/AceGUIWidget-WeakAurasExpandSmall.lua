...
local methods = {
  ...
  ["SetImage"] = function(self, path, ...)
    ...
    if path == "collapsed" then
      ...
      path = OptionsPrivate.GetTexture("gear")
    elseif path == "expanded" then
      self:SetExpandedState(true)
      path = OptionsPrivate.GetTexture("geardown")
    else
      self:SetExpandedState(false)
    end
...
local function Constructor()
  ...
  highlight:SetTexture(OptionsPrivate.GetTexture("Square_White"))
  ...
  expandedHighlight:SetTexture(OptionsPrivate.GetTexture("Square_White"))
  ...
  expandedBackground:SetTexture(OptionsPrivate.GetTexture("Square_AlphaGradient"))
