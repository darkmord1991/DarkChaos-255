...
function OptionsPrivate.CreateFrame()
  ...
  frame:SetBackdrop({
    bgFile = OptionsPrivate.GetTexture("Square_FullWhite"),
  ...
  addFooter(L["Get Help"], OptionsPrivate.GetTexture("discord.tga"), "https://discord.gg/UXSc7nt",
            L["Chat with WeakAuras experts on our Discord server."])

  addFooter(L["Documentation"], OptionsPrivate.GetTexture("GitHub.tga"), "https://github.com/WeakAuras/WeakAuras2/wiki",
            L["Check out our wiki for a large collection of examples and snippets."])

  addFooter(L["Find Auras"], OptionsPrivate.GetTexture("wagoupdate_logo.tga"), "https://wago.io",
            L["Browse Wago, the largest collection of auras."])

  if not OptionsPrivate.Private.CompanionData.slugs then
    addFooter(L["Update Auras"], OptionsPrivate.GetTexture("wagoupdate_refresh.tga"), "https://weakauras.wtf",
            L["Keep your Wago imports up to date with the Companion App."])
  end

  addFooter(L["Found a Bug?"], OptionsPrivate.GetTexture("bug_report.tga"), "https://github.com/Bunny67/WeakAuras-WotLK/issues/new?assignees=&labels=bug&template=bug_report.md&title=",
  ...
  newButton:SetTexture(OptionsPrivate.GetTexture("newaura"))
  ...
  importButton:SetTexture(OptionsPrivate.GetTexture("importsmall"))
  ...
  lockButton:SetTexture(OptionsPrivate.GetTexture("lockPosition"))
  ...
  magnetButton:SetTexture(OptionsPrivate.GetTexture("magnetic"))
