...
local ICON_CHOICES = {
    ...
    { value = "treasure",label = "Treasure Chest" },
    -- Retail vignette markers (downported); same art as the rare/boss pins.
    { value = "rare",       label = "Rare Skull (blue ring)" },
    { value = "chest",      label = "Chest (blue ring)" },
    { value = "chestElite", label = "Chest (orange ring)" },
    { value = "shield",     label = "Shield (blue ring)" },
    { value = "shieldElite",label = "Shield (orange ring)" },
    { value = "quest",   label = "Quest Note" },
    { value = "map",     label = "Classic Map Icon" },
    { value = "target",  label = "Target Reticle" },
    { value = "skull",   label = "Elite Skull (orange ring)" },
