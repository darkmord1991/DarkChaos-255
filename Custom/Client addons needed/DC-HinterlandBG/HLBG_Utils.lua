...
HLBG.QueueTextTemplates = HLBG.QueueTextTemplates or {
    ...
    fallback_no_transport = "|cFFFFAA00HLBG Queue:|r No DC protocol or AIO detected. Falling back to chat commands.",
    fallback_join_hint = "|cFFFFAA00HLBG Queue:|r Try |cFFFFFFFF/hlbgq join|r or |cFFFFFFFF.hlbg queue join|r.",
    ...
    no_response = "|cFFFF5555HLBG Queue:|r No response received. Try |cFFFFFFFF/hlbgq status|r or |cFFFFFFFF.hlbg queue status|r again.",
