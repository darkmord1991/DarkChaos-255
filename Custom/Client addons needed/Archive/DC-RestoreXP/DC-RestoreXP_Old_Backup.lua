...
if DCRestoreXPDB.y == nil then DCRestoreXPDB.y = -30 end
if DCRestoreXPDB.anchor == nil then DCRestoreXPDB.anchor = "TOP" end
...
SlashCmdList["DCRXP"] = function(msg)
    ...
    if cmd == "reset" or cmd == "r" then
        DCRestoreXPDB.x = 0; DCRestoreXPDB.y = -30; DCRestoreXPDB.point = "BOTTOM"; DCRestoreXPDB.anchor = "TOP"
