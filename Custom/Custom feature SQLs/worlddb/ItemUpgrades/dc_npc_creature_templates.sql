 ...
 * - ID 190003: Item Upgrader (Main upgrade interface)
 * 
...
DELETE FROM `creature_template_model` WHERE `CreatureID` IN (190001, 190002, 190003);
INSERT INTO `creature_template_model` (`CreatureID`, `Idx`, `CreatureDisplayID`, `DisplayScale`, `Probability`, `VerifiedBuild`) VALUES
(190001, 0, 4286, 1, 1, 12340),  -- Human merchant model
(190002, 0, 4299, 1, 1, 12340),  -- Dwarf model
(190003, 0, 5233, 1, 1, 12340);  -- Gnome engineer model

-- Item Upgrader (ID: 190003) - Main upgrade interface
...
(`entry`, `difficulty_entry_1`, `difficulty_entry_2`, `difficulty_entry_3`, `KillCredit1`, `KillCredit2`, 
 ...
 `spell_school_immune_mask`, `flags_extra`, `ScriptName`, `VerifiedBuild`) 
VALUES 
(190003, 0, 0, 0, 0, 0, 'Item Upgrader', 'Item upgrade interface coming in Phase 4B!', NULL, 0, 
 63, 63, 2, 35, 1, 1, 1.14286, 1, 1, 18, 1, 0, 0, 1, 2000, 2000, 1, 1, 1, 32768, 2048, 0, 0, 0, 0, 0, 0, 
 7, 0, 0, 0, 0, 0, 0, 0, 0, 'PassiveAI', 0, 1, 50, 10, 5, 1, 0, 0, 1, 0, 0, 0, 
