-- =====================================================================
-- Mount Hyjal (map 750) -- 60  Flight master gossip wiring
-- ---------------------------------------------------------------------
-- Binds the gossip flight master CreatureScript
-- (src/server/scripts/DC/AC/dc_downport_taxi.cpp,
--  "npc_dc_downport_flightmaster") to every flight master on map 750.
--
-- The script lists the map's flight nodes (TaxiNodes/TaxiPath/TaxiPathNode.dbc,
-- ids 421-425) as gossip options and starts the flight with ActivateTaxiPathTo,
