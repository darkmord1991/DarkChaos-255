...
-- Display scale (3.0 boss / 1.0 add) is set in creature_template_model.DisplayScale below; this core has no `scale` column on creature_template.
(400350,'Ancient Terror','Giant Isles Boss',83,83,2,14,0,1.0,1.14286,3,0,2000,2000,1,0,0,0,'npc_giant_water_monster',12340),
(400351,'Corrupted Elemental','Minion of the Deep',81,81,0,14,0,1.0,1.14286,1,0,2000,2000,1,0,0,0,'npc_corrupted_elemental',12340);
...
(400350, 0, 29487, 3.0, 1.0, 12340), -- Ancient Terror - DisplayScale 3.0 (boss size)
