...
DELETE FROM `creature_loot_template` WHERE `Entry` IN (4020001, 4020002, 4020005, 4020006, 4020007, 4020003, 4020004, 4020101, 4020102, 4020103, 4020104, 4020105, 4020106);
...
-- Report
-- -------------------------------------------------------------------------------------
SELECT 'loot rows (want 18)' AS `check`, CAST(COUNT(*) AS CHAR) AS result
    FROM `creature_loot_template` WHERE `Entry` IN (4020001, 4020002, 4020005, 4020006, 4020007, 4020003, 4020004, 4020101, 4020102, 4020103, 4020104, 4020105, 4020106)
UNION ALL SELECT 'loot pointing at a missing item (want 0)', CAST(COUNT(*) AS CHAR)
    ...
    WHERE l.`Entry` IN (4020001, 4020002, 4020005, 4020006, 4020007, 4020003, 4020004, 4020101, 4020102, 4020103, 4020104, 4020105, 4020106) AND l.`Reference` = 0 AND i.`entry` IS NULL
...
UNION ALL SELECT 'lootid <> entry on these creatures (want 0)', CAST(COUNT(*) AS CHAR)
    FROM `creature_template` WHERE `entry` IN (4020001, 4020002, 4020005, 4020006, 4020007, 4020003, 4020004, 4020101, 4020102, 4020103, 4020104, 4020105, 4020106) AND `lootid` <> `entry`;
