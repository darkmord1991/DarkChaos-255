...
-- IDs: 95100-95103
DELETE FROM `creature_template` WHERE `entry` BETWEEN 95100 AND 95103;
DELETE FROM `creature_template_model` WHERE `CreatureID` BETWEEN 95100 AND 95103;
...
DELETE FROM `dc_guild_house_spawns` WHERE `entry` BETWEEN 95100 AND 95103;
