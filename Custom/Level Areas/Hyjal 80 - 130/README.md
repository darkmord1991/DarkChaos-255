...
| Creature entries | `830000–830999` | 830000–830017 already used (Hyjal Summit reskins) |
| Gameobject entries | `830000–830999` | |
| Item entries | `400000–400999` | |
| Quest IDs | `81000–81500` | |
...
5. Apply `NPCs.sql` after re-targeting existing 830xxx spawns to map 1410
   (done below once the first Noggit pass fixes coordinates).
6. Script folder `src/server/scripts/DC/HyjalFrontier/` is wired into the
