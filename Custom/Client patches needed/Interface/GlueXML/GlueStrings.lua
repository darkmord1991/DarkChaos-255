...
RACE_INFO_PANDAREN = "The enigmatic pandaren have long been a mystery to the other races of Azeroth. The noble history of the pandaren people stretches back thousands of years, well before the empires of man and before even the sundering of the world.";
ABILITY_INFO_PANDAREN1 = "- The stat benefits from eating food are doubled.";
ABILITY_INFO_PANDAREN2 = "- Cooking skill increased by 15.";
ABILITY_INFO_PANDAREN3 = "- Your rested experience bonus lasts twice as long as normal.";
ABILITY_INFO_PANDAREN4 = "- You take half falling damage.";
ABILITY_INFO_PANDAREN5 = "- Strikes the target with a quaking palm, incapacitating them for 4 sec.";
RACE_INFO_VULPERA = "The vulpera are a race of small, fox-like nomads native to Vol'dun. Hardy survivors of the deserts, they travel in caravans, trading and scavenging, and have earned a reputation for resourcefulness far out of proportion to their size.";
ABILITY_INFO_VULPERA1 = "- Rummage through your bag for a useful item.";
ABILITY_INFO_VULPERA2 = "- Take half damage from Fire.";
ABILITY_INFO_VULPERA3 = "- Set up a camp you can return to later.";
ABILITY_INFO_VULPERA4 = "- Your pack animals carry more; bag space is at a premium.";
ABILITY_INFO_VULPERA5 = "- A keen nose warns you of nearby danger.";
RACE_INFO_ZANDALARITROLL = "The Zandalari are the oldest and proudest of the troll empires, rulers of Zuldazar and keepers of a civilisation that stretches back further than almost any other on Azeroth. They revere the loa, and their golden city has never fallen to an outside power.";
ABILITY_INFO_ZANDALARITROLL1 = "- Call upon the loa for a blessing.";
...
ABILITY_INFO_KULTIRAN3 = "- Increased skill in all professions.";
ABILITY_INFO_KULTIRAN4 = "- Reduced damage taken from sea creatures.";
