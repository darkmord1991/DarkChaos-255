...
3. Declare and call `AddSC_<name>()` from the relevant regional loader such as `Spells/spells_script_loader.cpp`, `EasternKingdoms/eastern_kingdoms_script_loader.cpp`, etc.
